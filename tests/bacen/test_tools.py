...
from mcp_brasil.bacen import tools
from mcp_brasil.bacen.catalog import SerieBCB
from mcp_brasil.bacen.schemas import SerieMetadados, SerieValor

CLIENT_MODULE = "mcp_brasil.bacen.client"
CATALOG_MODULE = "mcp_brasil.bacen.tools"
