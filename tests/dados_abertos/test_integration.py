...
from mcp_brasil.dados_abertos.schemas import ConjuntoDados, ConjuntoResultado
from mcp_brasil.dados_abertos.server import mcp

CLIENT_MODULE = "mcp_brasil.dados_abertos.client"
